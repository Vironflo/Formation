# Compte rendu — réunion du 20 août 2026

Jérôme,

Voilà ce qu'on s'est dit jeudi, filtré. Je garde ce qui te sert pour démarrer.
À lire avant mardi, ça te prend 10 minutes.

---

## Les dates

- Mardi 25 août — 2 h — mise en place de l'environnement de travail
- Mercredi 26 août — 3 h — lire et comprendre du code
- Mercredi 2 septembre — 3 h — débug
- Jeudi 3 septembre — 3 h — modifier sans casser
- Samedi 5 septembre — 4 h — automatiser et configurer

15 heures au total. Plage 14 h - 22 h, on cale l'heure exacte sur WhatsApp la veille.

---

## Ce que tu installes avant mardi

Quatre choses. Compte 45 minutes. Si ça coince, tu m'écris sur WhatsApp,
on ne va pas perdre la séance là-dessus.
...
- `code.visualstudio.com`, gros bouton bleu, options par défaut
- Une fois lancé : menu **Terminal**, puis **Nouveau terminal**
- Une zone sombre apparaît en bas de l'écran. C'est le terminal.
  On va y passer les 15 heures.
...
- `git-scm.com`, **Download for Windows**, tu cliques Next partout
- Vérification : dans le terminal de VS Code, tape `git --version`
...
- `github.com`, **Sign up**
- Prends un nom d'utilisateur court. Il apparaîtra dans l'adresse de tous tes projets,
  pendant des années.
- **Envoie-moi ce nom d'utilisateur dès que tu l'as.**

Ce dernier point me bloque. Tant que je n'ai pas ton identifiant, je ne peux pas te donner
accès au dossier de la formation. C'est deux minutes de ton côté.

### 4. Un compte Anthropic

- `claude.ai`, création du compte avec ton mail pro
...
On regarde ça ensemble mardi, l'accès pour la formation est de mon côté.

---

## Le lexique : lis-le avant mardi

Il est déjà dans ta boîte mail. C'est le seul devoir.
...
Ce qui reste flou, tu le notes. On démarre par tes questions.

---

## Ce que je t'envoie de mon côté

- Le dossier Drive partagé : lexique, notes de réunion, documents de travail.
  Tu y accèdes quand tu veux, y compris entre les séances.
- Ce compte rendu.
- L'accès GitHub de la formation, dès réception de ton identifiant.

---

## Ce qu'on fait mardi (2 h)

- On vérifie que les quatre installations répondent
...
## Ce qu'on a ouvert jeudi et qui reviendra

Rien à préparer, c'est juste pour que tu saches que je ne les ai pas oubliés.

- **PACK** et le référentiel de la Haute Autorité de Santé. Ton vrai projet, celui
  sur lequel on branchera tout en session 5.
...
En session 5, une heure vingt est réservée pour installer ça sur ton vrai projet.
...
Facture envoyée le 20 août. Pas de TVA, prestation intracommunautaire.
On démarre au paiement, comme tu l'as demandé.

---

## Si ça bloque avant mardi
